 ...
 */
public class HostSwitchingWilsonBalding extends AbstractTreeOperator {
    ...
    public HostSwitchingWilsonBalding(TreeModel tree, CophylogenyLikelihood cl, double weight) {
        this.tree = tree;
        cophylogenyLikelihood = cl;
...
//    	System.err.println("BEFORE: " + Tree.Utils.newick(tree, new TreeTraitProvider[]{cophylogenyLikelihood}));
        proposeTree();
...
//        System.err.println("AFTER: " + Tree.Utils.newick(tree, new TreeTraitProvider[]{cophylogenyLikelihood}));
        return logq;
    }
...
//		}
        ...
        tree.endTreeEdit();
//        System.err.println(cophylogenyLikelihood.isDirty());
//   	TreeSummaryStatistic cs = CherryStatistic.FACTORY.createStatistic();
//	if (cs.getSummaryStatistic(symbiontTree)[0] == 2 && logL == Double.NEGATIVE_INFINITY) System.err.println(Tree.Utils.newick(symbiontTree, new TreeTraitProvider[]{this}));

        cophylogenyLikelihood.setStatesForNode(iP, cophylogenyLikelihood.getStatesForNode(j));
//        if (cophylogenyLikelihood.getStatesForNode(iP) != cophylogenyLikelihood.getStatesForNode(getOtherChild(tree, PiP, iP)) && cs.getSummaryStatistic(tree)[0] == 2) {
//        	System.err.println(Tree.Utils.newick(tree, new TreeTraitProvider[]{cophylogenyLikelihood}));
//        	System.err.println("START DEBUG");
//        	System.err.println(cophylogenyLikelihood.getLogLikelihood());
...
//        }
    ...
    public String getOperatorName() {
        return HostSwitchingWilsonBaldingParser.HOST_SWITCHING_WILSON_BALDING + "(" + tree.getId() + ")";
    }
}
