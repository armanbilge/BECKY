...
public class CophylogenyLikelihoodWrapperForJPrIMEDLTRSModel extends
	...
	public CophylogenyLikelihoodWrapperForJPrIMEDLTRSModel(String name, Tree host, Tree guest,
		...
		Continuous1DPDDependent substPD = new JPrIMEContinuous1DPDDependentWrapperForBEASTDistribution(new NormalDistribution(1.0, 1.0));
